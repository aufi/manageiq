...
describe ManageIQ::Providers::Amazon::CloudManager::Refresher do
  ...
  def assert_specific_orchestration_stack
    expect(ManageIQ::Providers::Amazon::CloudManager::OrchestrationStack.where(:name => "cloudformation-spec").first.status_reason).to eq "The following resource(s) failed to create: [IPAddress, WebServerWaitCondition]. "
  ...
  def assert_specific_orchestration_stack_parameters
    ...
    expect(parameters).to have(2).items
  ...
  def assert_specific_orchestration_stack_resources
    ...
    expect(resources).to have(4).items
  ...
  def assert_specific_orchestration_stack_outputs
    ...
    expect(outputs).to have(1).items
