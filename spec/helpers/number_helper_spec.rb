...
describe ActionView::Helpers::NumberHelper do
  context "#number_to_human_size" do
    ...
    it "without options hash" do
      ...
      expect(helper.number_to_human_size(12345)).to eq '12.1 KB'
      expect(helper.number_to_human_size(1234567)).to eq '1.2 MB'
      expect(helper.number_to_human_size(1234567890)).to eq '1.1 GB'
      expect(helper.number_to_human_size(1234567890123)).to eq '1.1 TB'
      expect(helper.number_to_human_size(1025.terabytes)).to eq '1025 TB'
    ...
    it "with options hash" do
      expect(helper.number_to_human_size(1234567,           :precision => 2)).to eq '1.18 MB'
      ...
      expect(helper.number_to_human_size(1234567890123,     :precision => 0)).to eq '1 TB'
      expect(helper.number_to_human_size(524288000,         :precision => 0)).to eq '500 MB'
      expect(helper.number_to_human_size(41010,             :precision => 0)).to eq '40 KB'
      expect(helper.number_to_human_size(41100,             :precision => 0)).to eq '40 KB'
  ...
  it "#human_size_to_rails_method" do
    ...
    expect(helper.human_size_to_rails_method('1025 TB')).to eq '1025.terabytes'
  ...
  it "#number_to_rails_method" do
    ...
    expect(helper.number_to_rails_method(12345)).to eq '12.1.kilobytes'
    expect(helper.number_to_rails_method(1234567)).to eq '1.2.megabytes'
    expect(helper.number_to_rails_method(1234567890)).to eq '1.1.gigabytes'
    expect(helper.number_to_rails_method(1234567890123)).to eq '1.1.terabytes'
    expect(helper.number_to_rails_method(1025.terabytes)).to eq '1025.terabytes'
  ...
  it "#human_size_to_number" do
    ...
    expect(helper.human_size_to_number('1025 TB')).to eq 1025.terabytes
  ...
  it "#rails_method_to_human_size" do
    ...
    expect(helper.rails_method_to_human_size('1025.terabytes')).to eq '1025 TB'
  ...
  context "#mhz_to_human_size" do
    it "without options hash" do
      ...
      expect(helper.mhz_to_human_size(12345)).to eq '12.3 GHz'
      expect(helper.mhz_to_human_size(1234567)).to eq '1.2 THz'
      expect(helper.mhz_to_human_size(1234567890)).to eq '1234.6 THz'
      expect(helper.mhz_to_human_size(1234567890123)).to eq '1234567.9 THz'
      expect(helper.mhz_to_human_size("123")).to eq '123 MHz'
    ...
    it "with options hash" do
      expect(helper.mhz_to_human_size(1234567,        :precision => 2)).to eq '1.23 THz'
      expect(helper.mhz_to_human_size(3.14159265,     :precision => 4)).to eq '3.1416 MHz'
      expect(helper.mhz_to_human_size(1234567890123,  :precision => 0)).to eq '1234568 THz'
      expect(helper.mhz_to_human_size(524288000,      :precision => 0)).to eq '524 THz'
      expect(helper.mhz_to_human_size(41010,          :precision => 0)).to eq '41 GHz'
      expect(helper.mhz_to_human_size(41100,          :precision => 0)).to eq '41 GHz'
    ...
    it "with old precision argument" do
      expect(helper.mhz_to_human_size(1234567,        2)).to eq '1.23 THz'
      expect(helper.mhz_to_human_size(3.14159265,     4)).to eq '3.1416 MHz'
      expect(helper.mhz_to_human_size(1234567890123,  0)).to eq '1234568 THz'
      expect(helper.mhz_to_human_size(524288000,      0)).to eq '524 THz'
      expect(helper.mhz_to_human_size(41010,          0)).to eq '41 GHz'
      expect(helper.mhz_to_human_size(41100,          0)).to eq '41 GHz'
