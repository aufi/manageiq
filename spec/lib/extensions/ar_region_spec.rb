...
describe "AR Regions extension" do
  ...
  it ".compressed_id?" do
    expect(ManageIQ::Providers::Vmware::InfraManager::Vm.compressed_id?(5)).to be_false
    expect(ManageIQ::Providers::Vmware::InfraManager::Vm.compressed_id?(15)).to be_false
    expect(ManageIQ::Providers::Vmware::InfraManager::Vm.compressed_id?(25)).to be_false
    expect(ManageIQ::Providers::Vmware::InfraManager::Vm.compressed_id?("5")).to be_false
    expect(ManageIQ::Providers::Vmware::InfraManager::Vm.compressed_id?("1r5")).to be_true
    expect(ManageIQ::Providers::Vmware::InfraManager::Vm.compressed_id?("2r5")).to be_true
  end
