...
module MiqAeEngineSpec
  ...
  describe MiqAeEngine do
    ...
    context ".automation_attribute_is_array?" do
      it "is true" do
        expect(MiqAeEngine.automation_attribute_is_array?("Array::doesntmatter")).to be_true
      end
      ...
      it "is false" do
        expect(MiqAeEngine.automation_attribute_is_array?("somethingelse::doesntmatter")).to be_false
      end

      it "is false with nil value" do
        expect(MiqAeEngine.automation_attribute_is_array?(nil)).to be_false
      end
    end
